    ...
    return (
        <div className="max-w-6xl mx-auto p-4">
            <div className="border-l-4 border-red-600 pl-3 mb-6">
                <h3 className="font-bold text-2xl md:text-3xl text-gray-800">Bollywood News</h3>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="lg:w-1/2 relative group">
                    <div className="overflow-hidden rounded-lg shadow-md">
                        ...
                        <div className="absolute bottom-0 left-0 p-4 text-white">
                            <span className="bg-red-600 text-xs font-semibold px-2 py-1 rounded">Latest</span>
                            <h4 className="text-xl md:text-2xl font-bold mt-2 leading-tight">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                            </h4>
                            <p className="text-sm text-gray-300 mt-1">2 hours ago</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:w-1/2 space-y-4">
                    {[1, 2, 3, 4, 5].map((item) => (
                        <div key={item} className="flex gap-4 pb-4 border-b border-gray-200 last:border-0 group">
