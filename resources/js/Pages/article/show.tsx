            ...
            <div className="mx-auto my-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-6">
                    <img
                        ...
                        alt={article.title}
                        className="w-full h-96 sm:h-64 object-cover rounded-xl"
                        onError={(e) => {
                            console.log(`Failed to load image for ${article.title}:`, e.currentTarget.src);
                            e.currentTarget.src = defaultImage || "https://via.placeholder.com/800x400?text=News+Image";
                        }}
                    />
                </div>
                ...
                {/* Content Section */}
                <div
                    className="prose prose-lg max-w-none text-gray-700 bg-white p-6"
